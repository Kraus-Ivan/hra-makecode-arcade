...
sprites.onOverlap(SpriteKind.neznicitelny_enemy, SpriteKind.Player, function (sprite52, otherSprite22) {
    // odecteni zivota
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile12`, function (sprite3, location3) {
    if (naBobrovi == false) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestClosed, function (sprite6, location4) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile26`, function (sprite14, location9) {
    if (currentLevel == 5) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`wood`, function (sprite2, location2) {
    ...
    if (currentLevel == 4 && (bobr2.tileKindAt(TileDirection.Left, assets.tile`wood`) || bobr2.tileKindAt(TileDirection.Right, assets.tile`wood`))) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`active`, function (sprite102, location62) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`active_black`, function (sprite13, location8) {
    if (currentLevel == 5) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`hlina`, function (sprite32, location32) {
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.bobr, function (sprite5, otherSprite2) {
    otherSprite2.destroy(effects.coolRadial, 1)
    sprite5.destroy()
    tiles.setTileAt(otherSprite2.tilemapLocation(), assets.tile`myTile11`)
    if (otherSprite2.tileKindAt(TileDirection.Left, assets.tile`myTile11`) || otherSprite2.tileKindAt(TileDirection.Left, assets.tile`wood`)) {
        sprites.destroyAllSpritesOfKind(SpriteKind.bobr)
        zmena_sloupce()
    }
})
...
scene.onPathCompletion(SpriteKind.neznicitelny_enemy, function (sprite, location) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`koberec0`, function (sprite62, location42) {
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.enemyTree, function (sprite42, otherSprite6) {
    animation.runImageAnimation(
    otherSprite6,
    [img`
        ........................
    ...
    tiles.setTileAt(otherSprite6.tilemapLocation(), assets.tile`spawner`)
})
...
sprites.onOverlap(SpriteKind.cursor, SpriteKind.button, function (sprite4, otherSprite) {
    // menu
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Player, function (sprite52, otherSprite22) {
    // odecteni zivota
    sprite52.destroy(effects.disintegrate, 200)
    info.changeLifeBy(-1)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.neznicitelny_enemy, function (sprite11, otherSprite5) {
    sprite11.destroy()
    game.showLongText("Duchy asi nebudu moct zabít", DialogLayout.Bottom)
})
